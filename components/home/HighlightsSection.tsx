    ...
    <section className="w-full py-24 bg-white dark:bg-zinc-950">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-left reveal-view space-y-6">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li
                  key={index}
                  className="animate-fade-left reveal-view flex items-center gap-3 text-zinc-700 dark:text-zinc-300"
                >
          ...
          <div
            className="animate-fade-right reveal-view relative aspect-video rounded-xl bg-gradient-to-br from-zinc-200 to-zinc-300 dark:from-zinc-800 dark:to-zinc-900 shadow-2xl border border-zinc-200 dark:border-zinc-700 flex items-center justify-center overflow-hidden group"
          >
